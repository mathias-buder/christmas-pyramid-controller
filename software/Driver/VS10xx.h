...
void VS10xxVolumeSet(uint8_t ui8Volume);
void VS10xxVolumeMute(void);
bool VS10xxDataReady(void);
void VS10xxFilePathSet(char *cFilePath);
bool VS10xxBufferFeed(void);
bool VS10xxPlay(void);
void VS10xxStop(void);
void VS10xxPause(void);
VS10xxSTATE VS10xxStateGet(void);
