 ...
 * web site. It was modified to work with an EK-TM4C123GXL LaunchPad.
 * Since there is on on-board SD-Card connector a external connector have
 * to be used. The physical connection (SPI) has to be specified in the
 * define section at line 46 below.
 */
...
void power_on (void)
{
    ...
    ROM_SSIConfigSetExpClk(SDC_SSI_BASE, ROM_SysCtlClockGet(),
                           //SSI_FRF_MOTO_MODE_0, SSI_MODE_MASTER, 400000, 8);
                            SSI_FRF_MOTO_MODE_0, SSI_MODE_MASTER, 20000000, 8);
